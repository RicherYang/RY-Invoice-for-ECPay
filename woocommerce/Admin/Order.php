...
namespace RY\Invoice\Ecpay\WooCommerce\Admin;
...
final class Order
{
    ...
    {
        add_action('woocommerce_admin_order_data_after_billing_address', ['RY\Invoice\Ecpay\WooCommerce\Admin\MetaBoxes\Info', 'output']);
