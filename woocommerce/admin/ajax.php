...
final class RY_IFECPAY_WC_Admin_Ajax
{
    private static ?self $_instance = null;

    public static function instance(): RY_IFECPAY_WC_Admin_Ajax
    {
    ...
    public function get_invoice()
    {
        ...
        if ($order) {
            RY_IFECPAY_WC_Invoice_Api::instance()->get($order->get_id());
        }
    ...
    public function invalid_invoice()
    {
        ...
        $order = wc_get_order($order_ID);
        if ($order) {
            RY_IFECPAY_WC_Invoice_Api::instance()->invalid($order);
        }
