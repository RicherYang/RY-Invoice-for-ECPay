...
final class RY_IFECPAY_WC_Admin_Invoice
{
    protected static ?self $_instance = null;

    public static function instance(): RY_IFECPAY_WC_Admin_Invoice
    {
    ...
    {
        include_once RY_IFECPAY_PLUGIN_DIR . 'woocommerce/admin/meta-boxes/class-wc-meta-box-invoice-data.php';
        add_action('woocommerce_admin_order_data_after_billing_address', ['RY_IFECPAY_MetaBox_Invoice_Data', 'output']);

        include_once RY_IFECPAY_PLUGIN_DIR . 'woocommerce/admin/settings/invoice.php';
        RY_IFECPAY_WC_Admin_Setting_Invoice::instance();
    ...
    public function add_scripts()
    {
        ...
        if (in_array($screen_id, ['shop_order', 'edit-shop_order', 'woocommerce_page_wc-settings', 'woocommerce_page_wc-orders'])) {
            ...
            wp_localize_script('ry-invoice-admin-invoice', 'RyWaiAdminInvoiceParams', [
                'i18n' => [
                    'get' => __('Issue invoice.<br>Please wait.', 'ry-invoice-for-ecpay'),
                    'cancel' => __('Cancel get invoice.<br>Please wait.', 'ry-invoice-for-ecpay'),
                    'invalid' => __('Invalid invoice.<br>Please wait.', 'ry-invoice-for-ecpay'),
                ],
                '_nonce' => [
