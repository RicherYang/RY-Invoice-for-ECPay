    ...
    <tr>
        ...
        <td>
            <fieldset>
                ...
                <p class="description">
                    <?php echo wp_kses(
                        __('Unable to disable error level log. <strong>Note:</strong> The log may contain personal information.', 'ry-invoice-for-ecpay'),
                        ['strong' => []]
                    ); ?>
                </p>
            </fieldset>
    ...
    <tr>
        ...
        <td>
            <fieldset>
                ...
                <p class="description">
                    <?php echo wp_kses(
                        __('<strong>Note:</strong> For developers use ONLY.', 'ry-invoice-for-ecpay'),
                        ['strong' => []]
                    ); ?>
                </p>
            </fieldset>
