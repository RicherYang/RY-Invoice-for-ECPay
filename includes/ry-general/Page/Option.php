...
final class Option extends AbstractAdminPage
{
    ...
    {
        echo '<div class="wrap">';
        echo '<h1 class="wp-heading">' . esc_html__('Options', 'ry-invoice-for-ecpay') . '</h1>';

        echo '<form method="post" action="' . esc_url(admin_url('admin-post.php')) . '">';
        include __DIR__ . '/html/options.php';
        Utils::the_action_form_button('general-option', 'save-option', __('Save Changes', 'ry-invoice-for-ecpay'), 'submit', 'button-primary');
        echo '</form>';
